...
sma = AddState(sma, 'Name', 'CheckZoneOut', ...
    ...
    'OutputActions', actions.WaitingActionAfterStim); 
%% Now add the different choices and outcomes here
    ...
    sma = AddState(sma, 'Name', 'RewardM1First', ...
        ...
        'OutputActions', [actions.RewardFirstM1 actions.WaitingAction]);
...
%%%%%%%%%%% Start Beatriz Edited 
    sma = AddState(sma, 'Name', 'RewardM2Second', ...
        ...
        'OutputActions', [actions.RewardSecondM2 actions.WaitingAction]);
        %ORGINAL: 'Timer',choices.m2ValveTime,...
    ...
    sma = AddState(sma, 'Name', 'RewardM2First', ...
        ...
        'OutputActions', [actions.RewardFirstM2 actions.WaitingAction]);
    ...
    sma = AddState(sma, 'Name', 'RewardM1Second', ...
        ...
        'StateChangeConditions', {'Tup', 'BothRewarded'},...
        'OutputActions', [actions.RewardSecondM1 actions.WaitingAction]);
...
%%%%%%%%%%% End Beatriz Edited
    ...
    sma = AddState(sma, 'Name', 'PunishM1First', ...
        ...
        'OutputActions', actions.PunishFirstM1);
    ...
    sma = AddState(sma, 'Name', 'PunishM2First', ...
        ...
        'OutputActions', actions.PunishFirstM2);
