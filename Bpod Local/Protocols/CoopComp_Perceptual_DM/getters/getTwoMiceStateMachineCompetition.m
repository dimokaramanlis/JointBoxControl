function sma = getTwoMiceStateMachineCompetition(choices,actions,times,conditions)
sma = NewStateMachine();
...
%% Now add the different choices and outcomes here
    ...
    sma = AddState(sma, 'Name', 'RewardM1First', ...
        ...
        'StateChangeConditions', {'Tup', 'RewardedM1SoftDelay',...
                                  choices.m2CorrectChoice,'FullRewardM2',...
                                  choices.m2IncorrectChoice,'PunishM2Second'},...
        'OutputActions', [{choices.m1CorrectValve,1,'AnalogIn1', ['#' 1]} actions.WaitingAction]);
    
    sma = AddState(sma, 'Name', 'RewardedM1SoftDelay', ...
        'Timer',times.SoftDelay,...
        'StateChangeConditions', [{choices.m2CorrectChoice,'FullRewardM2'},...
                                  {choices.m2IncorrectChoice,'PunishM2Second'},...
                                  conditions.M1Terminate],...
        'OutputActions', actions.WaitingAction);
    
    % If M2 chooses within the delay, it gets full reward
    ...
    % If M2 chooses after the delay: punishment or second reward
    ...
    % For correct answer after delay, M2 gets PercentageRewardSecond
    ...
    sma = AddState(sma, 'Name', 'RewardM2First', ...
        'Timer',choices.m2ValveTime,...
        'StateChangeConditions', {'Tup', 'RewardedM2SoftDelay',...
                                  choices.m1CorrectChoice,'FullRewardM1',...
                                  choices.m1IncorrectChoice,'PunishM1Second'},...
        'OutputActions', [{choices.m2CorrectValve,1, 'AnalogIn1', ['#' 2]} actions.WaitingAction]);
    
    
     sma = AddState(sma, 'Name', 'RewardedM2SoftDelay', ...
        'Timer',times.SoftDelay,...
        'StateChangeConditions', [{choices.m1CorrectChoice,'FullRewardM1'},...
                                  {choices.m1IncorrectChoice,'PunishM1Second'},...
                                  conditions.M2Terminate],...
        'OutputActions', actions.WaitingAction);
    
    sma = AddState(sma, 'Name', 'FullRewardM1', ...
        'Timer',choices.m1ValveTime,...
        'StateChangeConditions', {'Tup', 'BothRewarded'},...
        'OutputActions', [{choices.m1CorrectValve,1,'SoftCode',100, 'AnalogIn1', ['#' 2]} actions.WaitingAction]);
    ...
    %ORIGINAL:Timer',choices.m1Valve,...
%%%%%%%%%%% End Beatriz Edited
