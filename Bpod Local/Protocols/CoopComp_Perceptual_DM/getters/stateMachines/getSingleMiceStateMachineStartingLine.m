function sma = getSingleMiceStateMachineStartingLine(choices,actions,times,conditions)
...
sma = AddState(sma, 'Name','InZoneTimer', ...
            ...
            'OutputActions', [actions.WaitingAction, {'GlobalTimerTrig', 2}]);
...
sma = AddState(sma, 'Name', 'MouseMakingDecision', ...
            ...
            'StateChangeConditions', [{choices.m1correctCross, 'CorrectCrossMakingDecision'},...
                                     {choices.m1IncorrectCross, 'WrongCross'},...
                                     {'Tup','customExit'},...
                                     {'GlobalTimer2_End','customExit'}],...
            'OutputActions', actions.StimulusPresentationAction);
sma = AddState(sma, 'Name', 'CorrectCrossMakingDecision', ...
            'Timer',times.DecisionTimeout,...
...
% sma = AddState(sma, 'Name', 'SustainedPokeCondition', ...
%             'Timer',times.RewardDelay,...
%             'StateChangeConditions',{'Tup', 'Reward', choices.OutOfPoke, 'MouseMakingDecision'},...
%             'OutputActions', actions.WaitingAction);
