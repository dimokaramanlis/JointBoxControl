...
sma = AddState(sma, 'Name', 'MouseInZone', ...
            'Timer',0,...
            'StateChangeConditions', {'Tup', 'MouseCrossing'},...
            'OutputActions', actions.StimulusPresentationAction);
sma = AddState(sma, 'Name', 'MouseCrossing', ...
            'Timer',times.NoCrossTimeout,...
            'StateChangeConditions', [{choices.m1correctCross, 'MouseMakingDecision'},...
                                     {choices.m1IncorrectCross, 'customExit'},...
                                     {'Tup','customExit'}],...
            'OutputActions', actions.StimulusPresentationAction);
