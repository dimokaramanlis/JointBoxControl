...
%% Now add the different choices and outcomes here
    ...
    sma = AddState(sma, 'Name', 'RewardedM1SoftDelay', ...
        ...
        'StateChangeConditions', {choices.m2CorrectChoice,'RewardM2',...
                                  choices.m2InCorrectChoice,'PunishM2Second',...
                                  'Tup','RewardedM1WaitingM2'},...
        'OutputActions', actions.WaitingAction);
    
    sma = AddState(sma, 'Name', 'RewardM2', ...
    ...
    sma = AddState(sma, 'Name', 'RewardM2First', ...
     ...
     sma = AddState(sma, 'Name', 'RewardedM2SoftDelay', ...
        'Timer',times.SoftDelay,...
        'StateChangeConditions', {choices.m1CorrectChoice,'RewardM1',...
                                  choices.m1IncorrectChoice,'PunishM1Second',...
                                  'Tup','RewardedM2WaitingM1'},...
        'OutputActions', actions.WaitingAction);
    
    sma = AddState(sma, 'Name', 'RewardM1', ...
        'Timer',choices.m1ValveTime,...
        'StateChangeConditions', {'Tup', 'BothRewarded'},...
