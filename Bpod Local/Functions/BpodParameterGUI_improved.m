...
function paramStructOut = BpodParameterGUI_improved(op, paramStructIn)
...
switch op
    case 'init'
        ...
        hPos = 10;
        maxVPos = 0;
        BpodSystem.ProtocolFigures.ParameterGUI = figure('Position', [50 50 columnwidth guiHeight],'name', 'Parameter GUI',...
        ...
        for p = 1:nPanels
            ...
            uipanel('title', panelNames{p},'FontSize',fontsize, 'FontWeight', 'Bold', 'BackgroundColor', 'white',...
                'Units', 'Pixels', 'Position',[hPos vPos columnwidth-20 thisPanelHeight]);
            inPanelPos = 10;
            for i = 1:nParams
                ...
                BpodSystem.GUIHandles.ParameterGUI.Labels(paramNum) = uicontrol('Style', 'text', 'String', thisParamName,... 
                    'Position', [hPos+5 vPos+inPanelPos tabwidthvalue 25], 'FontWeight', 'normal', 'FontSize', fontsize,... 
                ...
                switch lower(thisParamStyle)
                    case 'edit'
                        ...
                        BpodSystem.GUIHandles.ParameterGUI.Params(paramNum) = uicontrol('Style', 'edit',... 
                            'String', num2str(thisParam), 'Position', [hPos+tabwidthname vPos+inPanelPos+2 tabwidthvalue 25],... 
                            'FontWeight', 'normal', 'FontSize', fontsize, 'BackgroundColor','white', 'FontName',... 
                    ...
                    case 'text'
                        ...
                        BpodSystem.GUIHandles.ParameterGUI.Params(paramNum) = uicontrol('Style', 'text',... 
                            'String', num2str(thisParam), 'Position', [hPos+tabwidthname vPos+inPanelPos+2 tabwidthvalue 25],... 
                            'FontWeight', 'normal', 'FontSize', fontsize, 'BackgroundColor','white', 'FontName', 'Arial',...
                    ...
                    case 'checkbox'
                        ...
                        BpodSystem.GUIHandles.ParameterGUI.Params(paramNum) = uicontrol('Style', 'checkbox',... 
                            'Value', thisParam, 'String', '   (check to activate)', 'Position', [hPos+tabwidthname vPos+inPanelPos+4 tabwidthvalue 25],... 
                            'FontWeight', 'normal', 'FontSize', fontsize, 'BackgroundColor','white', 'FontName', 'Arial',...
                            'HorizontalAlignment','Center');
                    case 'popupmenu'
                        ...
                        BpodSystem.GUIHandles.ParameterGUI.Params(paramNum) = uicontrol('Style', 'popupmenu',... 
                            'String', thisParamString, 'Value', thisParam, 'Position', [hPos+tabwidthname vPos+inPanelPos+2 tabwidthvalue 25],... 
                            'FontWeight', 'normal', 'FontSize', fontsize, 'BackgroundColor','white', 'FontName', 'Arial',...
                            'HorizontalAlignment','Center');
                    case 'pushbutton'
                        ...
                        BpodSystem.GUIHandles.ParameterGUI.Params(paramNum) = uicontrol('Style', 'pushbutton',... 
                            'String', thisParamName, 'Position', [hPos+tabwidthname vPos+inPanelPos+2 tabwidthvalue 25], 'FontWeight', 'normal',... 
                            'FontSize', fontsize, 'BackgroundColor','white', 'FontName', 'Arial','HorizontalAlignment','Center',... 
                            'Callback', thisParam);
                    otherwise
        ...
        set(BpodSystem.ProtocolFigures.ParameterGUI, 'Position', [900 100 hPos+columnwidth maxVPos+10]);
    case 'sync'
