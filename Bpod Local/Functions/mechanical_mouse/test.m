...
rotationmode = 0;
velocitiescheck = [180 200 220 260 260 260];
...
%     end    
    i = 1;
    topFreq = 160;
    while i <= numel(velocitiescheck)
        topFreq = velocitiescheck(i);
        fprintf('Set New top frequency to: %d Hz', topFreq);
        myStepperBoard.setMotorTopFrequency(0, topFreq, rotationmode);
